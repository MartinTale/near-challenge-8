...
const CONTRACT_NAME = "dev-1638054922212-64782617055613" || "near-challenge-8.testnet";
  ...
  switch (env) {
    ...
    case "local":
      return {
        ...
        keyPath: `${"/home/martintale"}/.near/validator_key.json`,
...
async function initContract() {
  ...
  window.contract = await new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
    ...
    viewMethods: ["viewCandidates", "viewVotes", "viewLogs", "getLeadingCandidate"],
    // Change methods can modify the state. But you don't receive the returned value when called.
    changeMethods: ["addCandidate", "vote", "removeCandidate", "removeVote", "addCandidateTrumpMode", "addCandidateHitlerMode", "addCandidateSantaMode", "askCatToReviveCandidate", "vote360NoScopeMode", "startNewElection"],
...
},{}],"../node_modules/rxjs/internal/SubjectSubscription.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./Subscription":"../node_modules/rxjs/internal/Subscription.js"}],"../node_modules/rxjs/internal/Subject.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./Observable":"../node_modules/rxjs/internal/Observable.js","./Subscriber":"../node_modules/rxjs/internal/Subscriber.js","./Subscription":"../node_modules/rxjs/internal/Subscription.js","./util/ObjectUnsubscribedError":"../node_modules/rxjs/internal/util/ObjectUnsubscribedError.js","./SubjectSubscription":"../node_modules/rxjs/internal/SubjectSubscription.js","../internal/symbol/rxSubscriber":"../node_modules/rxjs/internal/symbol/rxSubscriber.js"}],"../node_modules/rxjs/internal/operators/refCount.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../Subscriber":"../node_modules/rxjs/internal/Subscriber.js"}],"../node_modules/rxjs/internal/observable/ConnectableObservable.js":[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../Subject":"../node_modules/rxjs/internal/Subject.js","../Observable":"../node_modules/rxjs/internal/Observable.js","../Subscriber":"../node_modules/rxjs/internal/Subscriber.js","../Subscription":"../node_modules/rxjs/internal/Subscription.js","../operators/refCount":"../node_modules/rxjs/internal/operators/refCount.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _ConnectableObservable = require("rxjs/internal/observable/ConnectableObservable");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const {
  networkId
} = (0, _config.default)("development"); // global variable used throughout
...
window.addEventListener("DOMContentLoaded", event => {
  ...
  function startLoadingButton(button) {
    ...
    button.style.alignItems = "center"; // button.style.width = size.width + "px";
  ...
  function stopLoadingButton(button, content) {
    ...
    button.style.display = "inherit"; // button.style.width = "inherit";
  ...
  const addCandidateHitlerButton = document.getElementById("save-new-candidate-hitler");
  const addCandidateTrumpButton = document.getElementById("save-new-candidate-trump");
  const addCandidateSantaButton = document.getElementById("save-new-candidate-santa");

  addCandidateButton.onclick = async () => {
    try {
      startLoadingButton(addCandidateButton); // make an update call to the smart contract
  ...
  addCandidateHitlerButton.onclick = async () => {
    try {
      startLoadingButton(addCandidateHitlerButton); // make an update call to the smart contract
      ...
      // re-enable the form, whether the call succeeded or failed
      stopLoadingButton(addCandidateHitlerButton, `<img src="https://img.icons8.com/dusk/64/000000/hitler--v1.png" />`);
    }
  };

  addCandidateTrumpButton.onclick = async () => {
    try {
      startLoadingButton(addCandidateTrumpButton); // make an update call to the smart contract
      ...
      // re-enable the form, whether the call succeeded or failed
      stopLoadingButton(addCandidateTrumpButton, `<img src="https://img.icons8.com/color/48/000000/donald-trump.png" />`);
    }
  };

  addCandidateSantaButton.onclick = async () => {
    try {
      startLoadingButton(addCandidateSantaButton); // make an update call to the smart contract
      ...
      // re-enable the form, whether the call succeeded or failed
      stopLoadingButton(addCandidateSantaButton, `<img src="https://img.icons8.com/office/80/000000/santa.png" />`);
    }
  };
  ...
  restartElectionButton.onclick = async e => {
    try {
      ...
      const response = await window.contract.startNewElection({}, BOATLOAD_OF_GAS);
      updateResponse(response.messages, response.success);
      updateCandidates();
    } catch (e) {
      console.log(e);
  ...
  randomVoteButton.onclick = async e => {
    try {
      ...
      const response = await window.contract.vote360NoScopeMode({}, BOATLOAD_OF_GAS);
      updateResponse(response.messages, response.success);
      updateCandidates();
    } catch (e) {
      console.log(e);
  ...
  function updateResponse(messages, success) {
    ...
    responseContainer.innerHTML = "<span>" + messages.join("</span><span>") + "</span>";
    setTimeout(() => {
  ...
  function randomizeAvatar(avatar) {
    ...
    avatarContainer.src = "https://avatars.dicebear.com/api/open-peeps/" + currentAvatar + ".svg";
  }
  ...
  async function updateCandidates() {
    try {
      ...
      const aliveCandidates = candidates.filter(candidate => candidate.value.alive);
      aliveCandidates.sort(sortByVotes);
      const deadCandidates = candidates.filter(candidate => candidate.value.alive === false);
      ...
      for (let i = 0; i < aliveCandidates.length; i += 1) {
        ...
        <img src="https://avatars.dicebear.com/api/open-peeps/${candidate.avatar}.svg">
        <div class="details">
      ...
      candidateListContainer.querySelectorAll(".vote").forEach(voteButton => {
      ...
      candidateListContainer.querySelectorAll(".kill").forEach(killButton => {
      ...
      candidateListContainer.querySelectorAll(".revive").forEach(reviveButton => {
        reviveButton.onclick = async e => {
          const target = e.target.closest(".revive");

          try {
            startLoadingButton(target);
            const response = await window.contract.askCatToReviveCandidate({
              candidateId: target.getAttribute("data-id")
            }, BOATLOAD_OF_GAS);
            updateResponse(response.messages, response.success);
            updateCandidates();
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js","./config":"config.js","big.js":"../node_modules/big.js/big.js","rxjs/internal/observable/ConnectableObservable":"../node_modules/rxjs/internal/observable/ConnectableObservable.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
